...
//	private String l_name;
	...
	public timelineDTO(int seq, int bbs_num, String id, String title, String content, String f_name, int t_like, String wdate, int del, String t_like_id) {
		super();
		this.seq = seq;
	...
	public timelineDTO(String id, String title, String content, String f_name) {
		super();
		this.id = id;
		this.title = title;
		this.content = content;
...
//		this.wdate = wdate;
	...
	public String toString() {
		return "timelineDTO [seq=" + seq + ", bbs_num=" + bbs_num + ", id=" + id + ", title=" + title + ", content="
